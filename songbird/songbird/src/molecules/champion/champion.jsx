  ...
  render(){
    ...
    return(
      <div className="champion col-12">
          ...
          <p className='champion__text'> Именное поэтому тебе присваивается звание "Птичьего гения".</p>
          ...
          <ul>
            ...
            <li>Теперь ты можешь спорить с друзьями, что отгадаешь, какой птичке принадлежит тот или иной голос.</li>
            <li> Теперь твои возможности безграничны.</li>
          </ul>
          </div>
          <div className="champion__repeate col-12">
            <div className="champion__repeate-text mb-4">
              Звание и твои новые способности-это, конечно, хорошо! Но мы знаем, что повторение - мать учения. Подтверди свои знания. 
            </div>
